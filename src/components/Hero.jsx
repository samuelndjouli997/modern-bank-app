...
const Hero = () => (
    <section id="hero" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
        ...
        {/* THIS is the div for the right side of the screen */}
        <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
            <img src={robot} alt="billing" className="w-[100%] h-[100%] relative z-[5]" />

            {/* glowing effect behind the img */}
            <div className="absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient" />
            <div className="absolute z-[1] w-[80%] h-[80%] rounded_full bottom-40 white__gradient" />
            <div className="absolute z-[1] w-[50%] h-[50%] rounded_full right-20 bottom-20 blue__gradient" />
        </div>
